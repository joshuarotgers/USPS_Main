...
// EventBroker defines a minimal pub/sub API for route events.
...
// NewRedisBroker creates a Redis-backed event broker from REDIS_URL.
...
// Subscribe subscribes to a route channel and returns a buffered stream.
...
// Unsubscribe closes the subscription channel.
func (b *RedisBroker) Unsubscribe(_ string, ch chan SSEEvent) {
...
// Publish sends an event to the route channel.
