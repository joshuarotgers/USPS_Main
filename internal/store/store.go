...
type Store interface {
	...
	GetHOS(ctx context.Context, tenantID, driverID string) (status string, hosState map[string]any, err error)
	...
	// Route path points (lat/lng) in leg order for mapping
	ListRoutePath(ctx context.Context, tenantID, routeID string) ([]model.GeoPoint, error)
